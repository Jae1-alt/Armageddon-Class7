...
The terraform code for this lab's infrastructure can be found in the `Lab_3a/Terraform/` directory, and has the following overall layout:
...
Verification for the integrity and compliance of the architecture (to satisfy Lab 3a), can be found in the 'DELIVERABLES.md' file in the `Lab_3a/` directory.

The auditing results along with the Auditor Narrative can be found in the `Lab_3b/` directory.
...
----
This is a draft to be updated soon.