    ...
    widgets = [
      {
        ...
        properties = {
          metrics = [
            ["AWS/ApplicationELB", "RequestCount", "LoadBalancer", module.main_vpc.alb_arn_suffix],
            [".", "HTTPCode_ELB_5XX_Count", ".", module.main_vpc.alb_arn_suffix]
          ]
          period = 300
          stat   = "Sum"
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/ApplicationELB", "TargetResponseTime", "LoadBalancer", module.main_vpc.alb_arn_suffix]
          ]
          period = 300
          stat   = "Average"
          region = var.aws_region
...
resource "aws_cloudwatch_metric_alarm" "chewbacca_alb_5xx_alarm01" {
  ...
  dimensions = {
    LoadBalancer = module.main_vpc.alb_arn_suffix
  }
